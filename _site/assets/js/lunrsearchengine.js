...
var documents = [{
    ...
    "id": 1,
    "url": "http://localhost:4000/aboutcoopgroup",
    ...
    "id": 5,
    "url": "http://localhost:4000/our-team",
    "title": "Our Team",
    ...
    "id": 7,
    "url": "http://localhost:4000/support-us-cards",
    "title": "Support Us",
    "body": "{% for item in site. support-us %} 	 	 			     {{item. title}}     {{item. description}}   Go there!  {% endfor %}"
    }, {
    "id": 8,
